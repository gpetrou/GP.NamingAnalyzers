...
public static class TypeSymbolExtensions
{
    ...
    public static bool HasOriginalDefinitionOrImplementsNamedTypeSymbolInterface(this ITypeSymbol typeSymbol, INamedTypeSymbol namedTypeSymbol)
    {
        ...
        bool isImplementingInterface = typeSymbol.AllInterfaces.Any(interfaceNamedTypeSymbol => interfaceNamedTypeSymbol.ConstructedFrom.Equals(namedTypeSymbol, SymbolEqualityComparer.Default));

        return isNamedTypeSymbol || isImplementingInterface;
    }
}
